...
const tracksData = [
    {
        ...
        // Зворотні лапки дозволяють робити текст з абзацами без помилок!
        lyrics: `Тут дуже темно...
Але чай ще гарячий.
Тіні танцюють на стінах,
Андрій спостерігає за нами.`
    }, // <--- ОСЬ ТУТ БРАКУВАЛО КОМИ! Я ЇЇ ДОДАВ :)
    {
        filename: 'ЛОЛОЛО.mp3', 
        title: 'ЛОЛОЛО', // Я трохи змінив назву, щоб відрізнялася від першої
        author: 'Психо-Андрій',
        coAuthor: 'Відьма з лісу',
        description: 'Містична мелодія, яка лунає з найтемніших куточків підвалу під підвалом.',
        lyrics: `Тут дуже темно...
