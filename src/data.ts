...
Андрельф, просто зайди — і все оживе вмить.`
    ...
    {
        filename: 'Бий москалів як дань Андрію!', 
        url: 'music/Бий москалів як дань Андрію!.mp3',
...
двічі, фінал, тричи фінал...`
    ...
    {
       filename: 'Котопес по Андрельфськи',
            url: 'public/music/Котопес по Андрельфськи.mp3',
        title: 'Котопес по Андрельфськи', 
        author: 'fehykitop',
                coAuthor: 'Andrelf',
         description: `Пісня про Кота і Пса Андрельфа`,
...
ще потім: Дані засекречено... дані засекречено...`
        }, 
    {
        filename: 'острів андрельфа', 
        url: 'music/острів андрельфа.mp3',
...
якщо є ми`
    ...
    {
        filename: 'Гоп мої Чайники', 
        url: 'public/music/Гоп мої Чайнки.mp3',
        title: 'Гоп мої Чайники', 
        author: 'fehykitop',
        coAuthor: 'Andrelf',
        description: 'Працювали цілий день',
